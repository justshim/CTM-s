...
def ga(stretch, phi, duration, rsmax, station):
    ...
    fac1.stretches[0].cells[station[1]].p_ms = fac1.stretches[0].cells[station[1]].p_ms - station[4]
    fac1.addStationToStretch(0, rsmax, station[0], station[1], station[2], station[3], station[4])
